...
func TestBuildInfraRdfGraph(t *testing.T) {
	...
	classicLbPages := []*elb.LoadBalancerDescription{
		{LoadBalancerName: awssdk.String("my_classic_loadbalancer_1"), VPCId: awssdk.String("vpc_1")},
	...
	expected := map[string]cloud.Resource{
		...
		"my_classic_loadbalancer_1": resourcetest.ClassicLoadBalancer("my_classic_loadbalancer_1").Prop(p.Name, "my_classic_loadbalancer_1").Prop(p.Vpc, "vpc_1").Build(),
